...
/***/ function(module, exports, __webpack_require__) {
	...
	var _employeeService = __webpack_require__(159);
	...
	var EmployeeGrid = function (_React$Component2) {
	  ...
	  function EmployeeGrid(props) {
	    ...
	    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(EmployeeGrid).call(this, props));

	    _this2.state = { employees: [] };
	    return _this2;
	  }
	  ...
	  _createClass(EmployeeGrid, [{
	    ...
	    value: function componentDidMount() {
	      //TODO: stack class
	      var employeeService = new _employeeService2.default();
	      this.setState({ employees: employeeService.getEmployees() });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var employeesList = this.state.employees.map(function (employee) {
	        return _react2.default.createElement(GridRow, { key: employee.name, employee: employee });
	      });
	      return _react2.default.createElement(
	        'table',
	...
	_reactDom2.default.render(_react2.default.createElement(EmployeeGrid, null), document.getElementById('root'));
